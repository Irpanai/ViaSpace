    ...
    <aside id="mainSidebar" class="sidebar-transition w-72 bg-gradient-to-b from-gray-900 to-gray-800 shadow-2xl flex-shrink-0 fixed md:sticky inset-y-0 left-0 z-50 md:z-10 transform -translate-x-full md:translate-x-0 flex flex-col h-[100dvh] text-white">
        ...
        <div class="p-4 flex-1 overflow-y-auto custom-scrollbar">
            ...
            <nav class="space-y-1.5">
                ...
                <a href="{{ route('intern.leave') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 {{ request()->routeIs('intern.leave') ? 'bg-orange-500/10 text-orange-400 font-medium border border-orange-500/20' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} sidebar-icon-container" title="Pengajuan Izin">
                    <svg class="w-6 h-6 flex-shrink-0 {{ request()->routeIs('intern.leave') ? 'text-orange-400' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    <span class="sidebar-text whitespace-nowrap">Pengajuan Izin</span>
                </a>
                ...
                <a href="{{ route('intern.grades.index') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 {{ request()->routeIs('intern.grades.*') ? 'bg-orange-500/10 text-orange-400 font-medium border border-orange-500/20' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} sidebar-icon-container" title="Rapor Penilaian">
                    <svg class="w-6 h-6 flex-shrink-0 {{ request()->routeIs('intern.grades.*') ? 'text-orange-400' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    <span class="sidebar-text whitespace-nowrap">Rapor Penilaian</span>
                </a>
            </nav>
